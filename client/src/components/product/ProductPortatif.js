...
function ProductPortatif() {
    ...
    return (
        <div>
            <CardGroup>
                <Col><h2 style={{ textAlign: "center", margin: "50px" }}>PC Portable </h2></Col>
                <Container fluid >
                    <Row >
                        <Col sm style={{ display: 'flex', flexWrap: "wrap", justifyContent: "center" }}>
                            {!product ? <Spinner animation="border" /> : product.filter((el) => el.category == "PC_PORTATIF").map((e) =>
...
export default ProductPortatif
